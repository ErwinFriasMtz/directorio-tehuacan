	...
	<footer id="colophon" class="site-footer" role="contentinfo">
		...
		<div class="footer-text-area">
			...
			<div class="theme-info">
				<p>Desarrollado por <a href="<?php echo esc_url( esc_html__( 'http://erwcode.com', 'listable' ) ); ?>" target="_blank"><?php printf( esc_html__( 'ERwCode | Diseño y Desarrollo Web', 'listable' ), 'WordPress' ); ?> </a></p>
			</div>
		</div>
	</footer><!-- #colophon -->
</div><!-- #page -->
